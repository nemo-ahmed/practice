...
export function run() {
  ...
  console.log(
    generateBC(
      'https://www.codewars.com/cauterization-biotechnology-uber-or-of-with/with-insider-surfer-the-bladder-kamehameha-diplomatic/games/images',
      ' >>> ',
    ),
  );
  console.log(
    generateBC(
      'github.com/pictures-you-wished-you-never-saw-but-you-cannot-unsee-now/profiles/for-in-a-for-insider-transmutation-immunity/paper-skin-insider-in-meningitis-or-with?previous=normalSearch&output=full',
      ' >>> ',
    ),
  );
  console.log(
  ...
  console.log(
    generateBC(
      'linkedin.it/transmutation-biotechnology-of-skin-at-biotechnology/files/surfer-transmutation-insider/with-pippi-the-bladder-of-surfer',
      ' ; ',
    ),
  );
}
